...
insert into usuario (usuario_id, email, nombre_usuario, nombre, apellido_paterno, apellido_materno, contrasenia) values (usuario_seq.nextval, 'ricardito@walmart.com', 'plugin', 'Ricardo', 'Garcia', 'Vasco', '1q2w3e4r');
...
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, 11.4865869, 58.3786073, '75099 Rieder Terrace', 150, 'Casa diseñada para maxima comodidad', to_date('05/12/2019', 'dd/mm/yyyy'), 1, 1, 0, 2, 11);
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, 23.5966577, -6.1306709, '51 Sutherland Drive', 100, 'Oasis para pasarla bien', to_date('05/12/2019', 'dd/mm/yyyy'), 0, 1, 0, 3, 11);
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, 20.7487901, 42.4090329, '306 Porter Way', 30, 'La mejor casa del universo', to_date('01/01/2019', 'dd/mm/yyyy'), 1, 1, 0, 2, 11);
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, 119.549776, 26.489558, '7554 Ronald Regan Place', 2, 'Pequeño apartamento en venta', to_date('05/10/2019', 'dd/mm/yyyy'), 0, 0, 1, 4, 11);
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, -0.7117137, 6.6058668, '83499 Hagan Point', 3, 'Vecinos amigables', to_date('05/12/2019', 'dd/mm/yyyy'), 0, 0, 1, 6, 11);
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, -8.4270764, 40.1628977, '946 Pankratz Way', 15, 'Siempre querras estar aqui', to_date('05/12/2019', 'dd/mm/yyyy'), 1, 1, 0, 3, 11);
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, 48.3896404, 40.5742298, '11069 Carberry Terrace', 20, 'Casa roja de cinco pisos y dos baños', to_date('27/06/2019', 'dd/mm/yyyy'), 0, 0, 1, 5, 11);
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, 153.5799639, 5.5775857, '184 Dayton Parkway', 5, 'Casa para familia de cinco personas', to_date('07/12/2019', 'dd/mm/yyyy'), 1, 0, 0, 1, 11);
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, 123.8401962, 9.7457208, '1857 Hayes Parkway', 5, 'El mejor hogar de la galaxia', to_date('07/06/2018', 'dd/mm/yyyy'), 0, 0, 1, 5, 11);
insert into vivienda (vivienda_id, longitud, latitud, direccion, capacidad, descripcion, fecha_status, es_renta, es_vacacion, es_venta, status_vivienda_id, usuario_id) values (vivienda_seq.nextval, -85.1872878, 42.319384, '59 Menomonie Street', 182, 'Diseñada para fiestas extravagantes', to_date('07/12/2019', 'dd/mm/yyyy'), 0, 1, 0, 1, 11);
...
insert into alquiler (alquiler_id, folio, fecha_inicio, fecha_fin, precio_total, usuario_id, vivienda_id) values (alquiler_seq.nextval, '0005UYZ601TY4F17934', to_date('15/12/2019', 'dd/mm/yyyy'), to_date('01/01/2020', 'dd/mm/yyyy'),16734, 4, 2);
insert into alquiler (alquiler_id, folio, fecha_inicio, fecha_fin, precio_total, usuario_id, vivienda_id) values (alquiler_seq.nextval, '2305UT8U01TY4F14934', to_date('17/12/2019', 'dd/mm/yyyy'), to_date('03/02/2020', 'dd/mm/yyyy'),85678, 5, 6);
...
insert into mensaje (mensaje_id, contenido, visto, respuesta_id, usuario_id, vivienda_id) values (mensaje_seq.nextval, 'necesito informes', 1, null, 5, 2);
insert into mensaje (mensaje_id, contenido, visto, respuesta_id, usuario_id, vivienda_id) values (mensaje_seq.nextval, 'te paso mi numero para los informes 5534567709', 0, 2,  10, 2);
...
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'GIMNASIO','Gimnasio incluido en la vivienda', bfilename('MULTIMEDIA','icono.png'));
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'WIFI','Internet incluido en la vivienda', bfilename('MULTIMEDIA','icono.png'));
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'ALBERCA','Alberca incluido en la vivienda', bfilename('MULTIMEDIA','icono.png'));
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'SPA','Spa de belleza incluido en la vivienda', bfilename('MULTIMEDIA','icono.png'));
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'ESTACIONAMIENTO','Lugar de estacionamiento incluido en la vivienda', bfilename('MULTIMEDIA','icono.png'));
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'TELEVISION','Television incluida en la vivienda', bfilename('MULTIMEDIA','icono.png'));
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'AIRE ACONDICIONADO','Aire acondicionado incluido en la vivienda', bfilename('MULTIMEDIA','icono.png'));
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'REFRIGERADOR','Refrigerador incluido en la vivienda', bfilename('MULTIMEDIA','icono.png'));
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'BAÑO','Baño completo incluido en la vivienda', bfilename('MULTIMEDIA','icono.png'));
insert into servicio (servicio_id, nombre, descripcion, icono) values (servicio_seq.nextval, 'PATIO','Patio incluido en la vivienda', bfilename('MULTIMEDIA','icono.png'));
